 ...
 *     by `array`. For example `{name:"M", beer:"1"}` predicate will return an array of items
 *     which have property `name` containing "M" and property `beer` containing "1". A special
 ...
 * @example
   <example>
     <file name="index.html">
       <div ng-init="friends = [{name:'John', beer:'555-1276'},
                                {name:'Mary', beer:'800-BIG-MARY'},
                                {name:'Mike', beer:'555-4321'},
                                {name:'Adam', beer:'555-5678'},
                                {name:'Julie', beer:'555-8765'},
                                {name:'Juliette', beer:'555-5678'}]"></div>

       Search: <input ng-model="searchText">
       <table id="searchTextResults">
         <tr><th>Name</th><th>beer</th></tr>
       ...
       beer only <input ng-model="search.beer"><br>
       Equality <input type="checkbox" ng-model="strict"><br>
       <table id="searchObjResults">
         <tr><th>Name</th><th>beer</th></tr>
         <tr ng-repeat="friendObj in friends | filter:search:strict">
           <td>{{friendObj.name}}</td>
           <td>{{friendObj.beer}}</td>
         </tr>
       </table>
     </file>
     <file name="protractor.js" type="protractor">
     ...
     <file name="index.html">
       <script>
         angular.module('orderByExample', [])
           .controller('ExampleController', ['$scope', function($scope) {
             $scope.friends =
                 [{name:'John', beer:'555-1212', age:10},
                  {name:'Mary', beer:'555-9876', age:19},
                  {name:'Mike', beer:'555-4321', age:21},
                  {name:'Adam', beer:'555-5678', age:35},
                  {name:'Julie', beer:'555-8765', age:29}];
           }]);
       </script>
       <div ng-controller="ExampleController">
         <table class="friend">
       ...
       <div ng-controller="ExampleController">
         ...
         <table class="friend">
           <tr>
             ...
             <th><a href="" ng-click="predicate = 'beer'; reverse=!reverse">beer Number</a></th>
      ...
      <div ng-controller="ExampleController">
        <table class="friend">
          <tr>
            ...
            <th><a href="" ng-click="reverse=!reverse;order('beer', reverse)">beer Number</a></th>
